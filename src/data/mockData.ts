...
export const mockMentors: Mentor[] = [
  {
    ...
    availableSlots: [
      { id: 1, startTime: '2025-06-15T10:00:00', endTime: '2025-06-15T10:30:00', status: 'AVAILABLE', booked: false },
      { id: 2, startTime: '2025-06-15T11:00:00', endTime: '2025-06-15T11:30:00', status: 'BOOKED', booked: true, bookedByTeamId: 1 },
      { id: 3, startTime: '2025-06-16T14:00:00', endTime: '2025-06-16T14:30:00', status: 'AVAILABLE', booked: false },
    ],
  ...
  },
  {
    ...
    availableSlots: [
      { id: 4, startTime: '2025-06-15T09:00:00', endTime: '2025-06-15T09:30:00', status: 'AVAILABLE', booked: false },
      { id: 5, startTime: '2025-06-15T15:00:00', endTime: '2025-06-15T15:30:00', status: 'AVAILABLE', booked: false },
    ],
  ...
  },
  {
    ...
    availableSlots: [
      { id: 6, startTime: '2025-06-16T10:00:00', endTime: '2025-06-16T10:30:00', status: 'AVAILABLE', booked: false },
      { id: 7, startTime: '2025-06-16T11:00:00', endTime: '2025-06-16T11:30:00', status: 'AVAILABLE', booked: false },
      { id: 8, startTime: '2025-06-17T09:00:00', endTime: '2025-06-17T09:30:00', status: 'BOOKED', booked: true, bookedByTeamId: 2 },
    ],
  ...
  },
  {
    ...
    availableSlots: [
      { id: 9, startTime: '2025-06-15T16:00:00', endTime: '2025-06-15T16:30:00', status: 'AVAILABLE', booked: false },
    ],
...
export const mockSubmissions: Submission[] = [
  ...
  { id: 7, hackathonId: 3, teamId: 3, teamName: 'MedAI', projectTitle: 'Rural Triage Assistant', description: 'Triage workflow for rural clinics using lightweight models.', repoUrl: 'https://github.com/example/triage', techStack: ['Python', 'FastAPI', 'React'], status: 'UNDER_REVIEW', submittedAt: '2025-05-20T14:00:00' },
  { id: 8, hackathonId: 4, teamId: 4, teamName: 'SecureX', projectTitle: 'Behavioral IDS Lite', description: 'ML-assisted intrusion hints for campus networks.', repoUrl: 'https://github.com/example/ids-lite', techStack: ['Python', 'Scikit-learn'], status: 'SUBMITTED', submittedAt: '2025-08-09T10:15:00' },
];
